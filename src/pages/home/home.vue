...
export default {
  ...
  data() {
    return {
      ...
      Everything:
        "Everything you need to have in order to build a stunning website",
      Our: "Our Works",
      demas: "我是绑定的数据",
      ins: false,
      nufd: [],
